...
public class SixthBattlePane extends GraphicsPane {
    ...
    private static final Color ENEMY_ACCENT = new Color(190, 140, 95);
    private static final Color ENEMY_HP     = new Color(170, 110, 70);
    ...
    private void buildSprites() {
        ...
        enemyImage = new GImage("brick.png");
        ...
        eSlab2.setFillColor(new Color(70, 45, 25));
        eSlab2.setColor(new Color(42, 25, 12));
        addObj(eSlab2);

        GRect eSlab1 = new GRect(eCenterX - eStoneW / 2, eStoneY, eStoneW, eStoneH);
        eSlab1.setFilled(true);
        eSlab1.setFillColor(new Color(145, 95, 55));
        eSlab1.setColor(new Color(95, 58, 30));
        addObj(eSlab1);
