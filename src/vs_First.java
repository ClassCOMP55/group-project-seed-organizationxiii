...
public class vs_First extends GraphicsPane {
    ...
    private GPolygon decimaStone;
    private GPolygon decimaStoneShade;
    private GOval decimaStoneShadow;
    ...
    private double frameOuterMargin() {
        return S(20);
    }
    ...
    private void drawDecimaStone() {
        ...
        decimaStoneShadow = new GOval(
            stoneCX - stoneW * 0.42,
            stoneTopY + stoneH * 0.82,
            stoneW * 0.84,
            stoneH * 0.26
        );
        decimaStoneShadow.setFilled(true);
        decimaStoneShadow.setFillColor(new Color(0, 0, 0, 70));
        decimaStoneShadow.setColor(new Color(0, 0, 0, 0));
        addObj(decimaStoneShadow);

        decimaStoneShade = new GPolygon();
        decimaStoneShade.addVertex(stoneCX - stoneW * 0.46, stoneTopY + stoneH * 0.18);
        decimaStoneShade.addVertex(stoneCX - stoneW * 0.18, stoneTopY + stoneH * 0.92);
        decimaStoneShade.addVertex(stoneCX + stoneW * 0.24, stoneTopY + stoneH * 0.92);
        decimaStoneShade.addVertex(stoneCX + stoneW * 0.48, stoneTopY + stoneH * 0.22);
        decimaStoneShade.setFilled(true);
        decimaStoneShade.setFillColor(new Color(44, 34, 58));
        decimaStoneShade.setColor(new Color(60, 48, 76));
        addObj(decimaStoneShade);

        decimaStone = new GPolygon();
        decimaStone.addVertex(stoneCX - stoneW * 0.40, stoneTopY);
        decimaStone.addVertex(stoneCX - stoneW * 0.12, stoneTopY + stoneH * 0.78);
        decimaStone.addVertex(stoneCX + stoneW * 0.16, stoneTopY + stoneH * 0.78);
        decimaStone.addVertex(stoneCX + stoneW * 0.40, stoneTopY + stoneH * 0.06);
        decimaStone.setFilled(true);
        decimaStone.setFillColor(new Color(72, 60, 92));
        decimaStone.setColor(new Color(96, 80, 120));
        addObj(decimaStone);
    ...
    private void drawDialogueUI() {
        ...
        double boxH = S(150);                     // slightly smaller height
        double boxW = sceneWidth() * 0.75;       // narrower
        double boxX = sceneLeft() + (sceneWidth() - boxW) / 2; // centered
        double boxY = sceneBottom() - boxH - S(60); // pushed UP
