...
public class vs_Second extends GraphicsPane {
    ...
    public vs_Second(MainApplication mainScreen) {
        this.mainScreen = mainScreen;
    }

    @Override
    public void showContent() {
        GImage enemy = new GImage("mint.png");
        enemy.scale(0.6, 0.6);
        ...
        GLabel nameLabel = new GLabel("Mint");
