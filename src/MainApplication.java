...
public class MainApplication extends GraphicsProgram{
	...
	public void switchToCutScene3Screen() {
		switchToScreen(cutScene3Pane);
	}
	
	public void switchToSecondBattleScreen() {
		switchToScreen(secondBattlePane);
	}
	...
	public void switchToFourthBattleScreen() {
	    if (currentScreen != null) {
	        currentScreen.hideContent();
	    }
	    currentScreen = fourthBattlePane;
	    currentScreen.showContent();
	}
	...
	public void switchToSeventhBattleScreen() {
		switchToScreen(seventhBattlePane);
	}
	
	public void switchToEighthBattleScreen() {
		switchToScreen(eighthBattlePane);
	}
