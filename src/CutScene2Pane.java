...
public class CutScene2Pane extends GraphicsPane {
	...
	public CutScene2Pane(MainApplication mainScreen) {
		this.mainScreen = mainScreen;
	}

	public void showContent() {

	    GImage image = new GImage("hyperioncutscene.png"); // you can change this later
	...
	private void advanceDialogue() {
	    ...
	    if (dialogueIndex < dialogue.length) {
	        ...
	        mainScreen.switchToLevelSelectScreen(); // change if needed
	    }
	}
	...
	public void mousePressed(MouseEvent e) {
	    ...
	    // Continue button = skip everything
