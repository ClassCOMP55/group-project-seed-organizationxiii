...
public class SeventhBattlePane extends GraphicsPane {
    ...
    private static final Color ENEMY_ACCENT = new Color(185, 60, 60);
    private static final Color ENEMY_HP     = new Color(160, 40, 40);
    ...
    public SeventhBattlePane(MainApplication mainScreen) {
    ...
    public void showContent() {
        ...
        enemy = new Loathe(1300, 38, 20, "Loathe");
    ...
    private void buildSprites() {
        ...
        enemyImage = new GImage("loathe.png");
        ...
        eSlab2.setFillColor(new Color(65, 20, 20));
        eSlab2.setColor(new Color(35, 10, 10));
        addObj(eSlab2);

        GRect eSlab1 = new GRect(eCenterX - eStoneW / 2, eStoneY, eStoneW, eStoneH);
        eSlab1.setFilled(true);
        eSlab1.setFillColor(new Color(130, 45, 45));
        eSlab1.setColor(new Color(85, 25, 25));
        addObj(eSlab1);
