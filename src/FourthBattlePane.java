...
public class FourthBattlePane extends GraphicsPane {
    ...
    private static final Color ENEMY_ACCENT = new Color(210, 150, 255);
    private static final Color ENEMY_HP     = new Color(190, 120, 255);
    ...
    public void showContent() {
        ...
        enemy = new Lavender(850, 28, 14, "Lavender");
    ...
    private void buildSprites() {
        ...
        eSlab2.setFillColor(new Color(65, 42, 95));
        eSlab2.setColor(new Color(40, 22, 60));
        addObj(eSlab2);

        GRect eSlab1 = new GRect(eCenterX - eStoneW / 2, eStoneY, eStoneW, eStoneH);
        eSlab1.setFilled(true);
        eSlab1.setFillColor(new Color(145, 95, 210));
        eSlab1.setColor(new Color(95, 58, 150));
        addObj(eSlab1);
