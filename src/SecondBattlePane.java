...
public class SecondBattlePane extends GraphicsPane {
    ...
    public void showContent() {
        ...
        superLabel.setFont("Times New Roman-Bold-10");
        ...
        mintHealthBar.setFillColor(Color.CYAN);
        ...
        huemanName.setFont("Times New Roman-Bold-14");
        huemanName.setLocation(huemanHealthBack.getX(), huemanHealthBack.getY() - 5);

        mintName = new GLabel(m1.getName());
        mintName.setFont("Times New Roman-Bold-14");
        mintName.setLocation(mintHealthBack.getX(), mintHealthBack.getY() - 5);
        ...
        actionBox.setFillColor(new Color(120, 120, 120));
        actionBox.setColor(new Color(120, 120, 120));
        ...
        fightOption.setFont("Times New Roman-Bold-18");
        fightOption.setLocation(boxX + 20, boxY + 40);
        
        mainScreen.add(fightOption);
        contents.add(fightOption);
        
        continueButton = new GRect(MainApplication.WINDOW_WIDTH - 180, MainApplication.WINDOW_HEIGHT - 50, 160, 25);
