...
public class ThirdBattlePane extends GraphicsPane {
    ...
    private void buildSprites() {
        ...
        eSlab2.setFillColor(new Color(24, 70, 60));
        eSlab2.setColor(new Color(14, 40, 35));
        addObj(eSlab2);

        GRect eSlab1 = new GRect(eCenterX - eStoneW / 2, eStoneY, eStoneW, eStoneH);
        eSlab1.setFilled(true);
        eSlab1.setFillColor(new Color(55, 140, 120));
        eSlab1.setColor(new Color(30, 85, 72));
        addObj(eSlab1);

        double ex = eCenterX - slujupiterImage.getWidth() / 2;
        double ey = eStoneY - slujupiterImage.getHeight() + S(10);
        slujupiterImage.setLocation(ex, ey);
        addObj(slujupiterImage);
    }
    ...
    private void buildEnemyHUD() {
        ...
        slujupiterNameLabel = new GLabel(s1.getName().toUpperCase());
        slujupiterNameLabel.setFont(new Font("Georgia", Font.BOLD, Math.max(12, (int) S(28))));
        slujupiterNameLabel.setColor(ENEMY_ACCENT);
        slujupiterNameLabel.setLocation(px + S(18), py + ph * 0.35);
        addObj(slujupiterNameLabel);

        slujupiterHpLabel = new GLabel("HP");
        slujupiterHpLabel.setFont(new Font("Courier New", Font.BOLD, Math.max(10, (int) S(14))));
        slujupiterHpLabel.setColor(TEXT_BRIGHT);
        slujupiterHpLabel.setLocation(px + S(18), py + ph * 0.70);
        addObj(slujupiterHpLabel);
        ...
        slujupiterHealthBack = new GRect(bx, by, bw, bh);
        slujupiterHealthBack.setFilled(true);
        slujupiterHealthBack.setFillColor(new Color(30, 30, 50));
        slujupiterHealthBack.setColor(new Color(60, 60, 90));
        addObj(slujupiterHealthBack);

        slujupiterHealthBar = new GRect(bx, by, bw, bh);
        slujupiterHealthBar.setFilled(true);
        slujupiterHealthBar.setFillColor(ENEMY_HP);
        slujupiterHealthBar.setColor(ENEMY_HP.darker());
        addObj(slujupiterHealthBar);
    }
    ...
    private void updateHealthBars() {
        ...
        double eRatio = Math.max(0, (double) s1.getHP() / slujupiterMaxHP);
        ...
        slujupiterHealthBar.setSize(
                slujupiterHealthBack.getWidth() * eRatio,
                slujupiterHealthBack.getHeight()
        );
