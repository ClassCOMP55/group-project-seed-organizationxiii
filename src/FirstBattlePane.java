...
//        GRect horizonBand = new GRect(0, Y(485), W, S(110));
//        horizonBand.setFilled(true);
//        horizonBand.setFillColor(BG_MID);
//        horizonBand.setColor(BG_MID);
//        addObj(horizonBand);

//        groundPanel = new GRect(0, Y(595), W, H - Y(595));
//        groundPanel.setFilled(true);
//        groundPanel.setFillColor(GROUND_COLOR);
//        groundPanel.setColor(GROUND_COLOR);
//        addObj(groundPanel);

//        GRect lowerGround = new GRect(0, Y(730), W, H - Y(730));
//        lowerGround.setFilled(true);
//        lowerGround.setFillColor(new Color(28, 35, 72));
//        lowerGround.setColor(new Color(28, 35, 72));
//        addObj(lowerGround);
    ...
    private void buildSprites() {
        ...
        dSlab2.setFillColor(new Color(55, 44, 22));
        dSlab2.setColor(new Color(38, 30, 12));
        addObj(dSlab2);

        GRect dSlab1 = new GRect(dCenterX - dStoneW / 2, dStoneY, dStoneW, dStoneH);
        dSlab1.setFilled(true);
        dSlab1.setFillColor(new Color(120, 95, 42));
        dSlab1.setColor(new Color(76, 60, 22));
        addObj(dSlab1);

        double dx = dCenterX - decimaImage.getWidth() / 2;
        double dy = dStoneY - decimaImage.getHeight() + S(10);
    ...
    private void buildEnemyHUD() {
        ...
        enemyHudAccent.setFillColor(ACCENT_GOLD);
        enemyHudAccent.setColor(ACCENT_GOLD);
        addObj(enemyHudAccent);

        decimaNameLabel = new GLabel(d1.getName().toUpperCase());
        decimaNameLabel.setFont(new Font("Georgia", Font.BOLD, Math.max(12, (int) S(28))));
        decimaNameLabel.setColor(ACCENT_GOLD);
        decimaNameLabel.setLocation(px + S(18), py + ph * 0.35);
        addObj(decimaNameLabel);

        decimaHpLabel = new GLabel("HP");
        decimaHpLabel.setFont(new Font("Courier New", Font.BOLD, Math.max(10, (int) S(14))));
        decimaHpLabel.setColor(TEXT_BRIGHT);
        decimaHpLabel.setLocation(px + S(18), py + ph * 0.70);
        addObj(decimaHpLabel);
        ...
        decimaHealthBack = new GRect(bx, by, bw, bh);
        decimaHealthBack.setFilled(true);
        decimaHealthBack.setFillColor(new Color(30, 30, 50));
        decimaHealthBack.setColor(new Color(60, 60, 90));
        addObj(decimaHealthBack);

        decimaHealthBar = new GRect(bx, by, bw, bh);
        decimaHealthBar.setFilled(true);
        decimaHealthBar.setFillColor(ENEMY_HP);
        decimaHealthBar.setColor(ENEMY_HP.darker());
        addObj(decimaHealthBar);
    }
    ...
    private void updateHealthBars() {
        ...
        double dRatio = Math.max(0, (double) d1.getHP() / decimaMaxHP);
        ...
        decimaHealthBar.setSize(
                decimaHealthBack.getWidth() * dRatio,
                decimaHealthBack.getHeight()
        );
